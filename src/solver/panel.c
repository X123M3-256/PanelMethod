...
//Write vertex normals
	...
	vertices[8*(mesh->num_vertices+i)+6]=texcoord(panel_values_x!=NULL?panel_values_x[i]:0.0);
	vertices[8*(mesh->num_vertices+i)+7]=texcoord(panel_values_y!=NULL?panel_values_y[i]:0.0);
